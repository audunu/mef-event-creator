  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {event.hero_image_url && (
        <div className="w-full h-[200px] md:min-h-[400px] md:h-[50vh] lg:min-h-[500px] lg:h-[60vh] lg:max-h-[700px] bg-muted overflow-hidden flex items-center justify-center">
          <img 
